...
<div class="regbox"><?php if(isset($_GET["errMsg"]) && ($_GET["errMsg"]=="1")){?>
          ...
          <label>
            <p>帳號：
              <br>
              <input name="username" type="text" class="logintextbox" id="username" placeholder="輸入帳號" value="<?php if(isset($_COOKIE["remUser"]) && ($_COOKIE["remUser"]!="")) echo $_COOKIE["remUser"];?>">
            </p>
          </label>
          <label>
            <p>密碼：<br>
              <input name="passwd" type="password" class="logintextbox" id="passwd" placeholder="輸入密碼" value="<?php if(isset($_COOKIE["remPass"]) && ($_COOKIE["remPass"]!="")) echo $_COOKIE["remPass"];?>">
            </p>  
          </label>
            <p>
              <label><input name="rememberme" type="checkbox" id="rememberme" value="true" checked>
記住我的帳號密碼。</p></label>
            <p align="center">
