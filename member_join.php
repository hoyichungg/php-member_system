  ...
  <tr>
    <td class="tdbline"><table width="100%" border="0" cellspacing="0" cellpadding="10">
      <tr valign="top">
		...
		<fieldset>
		<legend class="title"><strong>加入會員</strong></legend>

			<?php if(isset($_GET["errMsg"]) && ($_GET["errMsg"]=="1")){?>
          	<font color = red><div class="errDiv">帳號 <?php echo $_GET["username"];?> 已經有人使用！</div></font>
         	<?php }?>
          	<div class="dataDiv">

            <label><p>使用帳號：
            <input name="m_username" type="text" class="normalinput" id="m_username" placeholder="請填入英文字母、數字">
            <font color="#FF0000">*</font><br></p></label>

            <label><p>使用密碼：
            <input name="m_passwd" type="password" class="normalinput" id="m_passwd" placeholder="請填入英文字母、數字">
            <font color="#FF0000">*</font><br></p></label>

            <label><p>確認密碼：
            <input name="m_passwdrecheck" type="password" class="normalinput" id="m_passwdrecheck" placeholder="再填入一次">
            <font color="#FF0000">*</font> <br></p></label>
		</fieldset>

        <fieldset>    
            <legend class="heading"><strong>個人資料</strong></legend>

            <label><p>真實姓名：
            <input name="m_name" type="text" class="normalinput" id="m_name" placeholder="請填入姓名">
            <font color="#FF0000">*</font></p></label>

			<label><p>大頭貼：
			<input name="m_photo" type="file" class="normalinput" id="m_photo" value="<?php echo $row_RecMember["m_photo"];?>" >
			</p></label>
            ...
            <label><p>電子郵件：
            <input name="m_email" type="email" class="normalinput" id="m_email" placeholder="請填入可使用的電子郵件">
            <font color="#FF0000">*</font><br></p></label>

            <label><p>電　　話：
            <input name="m_phone" type="text" class="normalinput" id="m_phone" placeholder="請填入電話"></p></label>

           <label><p>住　　址：
            <input name="m_address" type="text" class="normalinput" id="m_address" size="40" placeholder="請填入住址"></p></label>

			<label><p>個人簡介：
            <textarea name="m_url" rows="10" cols="80" type="text" class="normalinput" id="m_url" placeholder="說點什麼吧！" value="<?php echo $row_RecMember["m_url"];?>"></textarea>
			</p></label>
